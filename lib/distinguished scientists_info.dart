              ...
              Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(widget.player.image1))),
                child: AspectRatio(
                  aspectRatio: 5 / 5,
                ),
              ),
...
final List<Person> alanTuringPersons = [
  Person(
      'Alan Turing',
      '''تاریخ و محل تولد: 23 ژوئن 1912 در لندن، انگلستان
زندگی و دستاوردها: تورینگ در یک خانواده مرفه به دنیا آمد و در دانشگاه‌های کمبریج و پرینستون تحصیل کرد. او یکی از پیشگامان علوم کامپیوتر و هوش مصنوعی بود. در دوران جنگ جهانی دوم، تورینگ با توسعه ماشین تورینگ و شکستن کد انیگما نقشی حیاتی در پیروزی متفقین داشت. پس از جنگ، او به کار روی هوش مصنوعی پرداخت.''',
      ...
      'https://www.google.com/search?q=alanTuring&oq=alanTuring&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDQyNDVqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8#vhid=irx2cLEX2W2VtM&vssid=l')
];

final List<Person> albertEinsteinPersons = [
  Person(
      'Albert Einstein',
      '''تاریخ و محل تولد: 14 مارس 1879 در اولم، پادشاهی وورتمبرگ، امپراتوری آلمان
...
final List<Person> charlesDarwinPersons = [
  Person(
      'CharlesDarwin',
      '''تاریخ و محل تولد: 12 فوریه 1809 در شروزبری، انگلستان
...
final List<Person> galileoGalileiPersons = [
  Person(
      'Galileo Galilei',
      '''تاریخ و محل تولد: 15 فوریه 1564 در پیزا، دوک‌نشین فلورانس (ایتالیای کنونی)
...
final List<Person> isaacNewtonPersons = [
  Person(
      'Isaac Newton',
      '''تاریخ و محل تولد: 25 دسامبر 1642 (4 ژانویه 1643 در تقویم میلادی) در وولستورپ، لینکلن‌شر، انگلستان
...
final List<Person> louisPasteurPersons = [
  Person(
      'Louis Pasteur',
      ''' تاریخ و محل تولد: 27 دسامبر 1822 در دول، فرانسه
...
final List<Person> marieCuriePersons = [
  Person(
      'Marie Curie',
      ''' تاریخ و محل تولد: 7 نوامبر 1867 در ورشو، لهستان
...
final List<Person> nikolaTeslaPersons = [
  Person(
      'Nikola Tesla',
      ''' تاریخ و محل تولد: 10 ژوئیه 1856 در اسمیلیان، امپراتوری اتریش (کرواسی کنونی)
...
final List<Person> stephenHawkingPersons = [
  Person(
      'Stephen Hawking',
      '''تاریخ و محل تولد: 8 ژانویه 1942 در آکسفورد، انگلستان
...
final List<Person> thomasEdisonPersons = [
  Person(
      'Thomas Edison',
      '''تاریخ و محل تولد: 11 فوریه 1847 در میلان، اوهایو، آمریکا
